...
export class EditDriverComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.editForm = new FormGroup({
      ...
      carBrand: new FormControl(this.driver.service.carBrand, [Validators.required]),
      carModel: new FormControl(this.driver.service.carModel, [Validators.required]),
      licensePlate: new FormControl(this.driver.service.licensePlate, [Validators.required]),
